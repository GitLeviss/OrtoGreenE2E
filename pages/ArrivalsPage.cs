...
namespace OrtoGreenE2E.pages
{
    public class ArrivalsPage
    {
        ...
        public async Task ScheduleAppointment()
        {
            ...
            {
                throw new PlaywrightException("Don´t possible Create a new Appointment");
            }
        ...
        public async Task ConsultExistingAppointment()
        {
            ...
            {
                throw new PlaywrightException("Don´t possible Consult a Existing appointment");
            }
        }
        public async Task Checkin()
        {
                ...
                {
                    throw new PlaywrightException("Don´t possible validate check-in");
                }
        ...
        public async Task Started()
        {
                ...
                {
                    throw new PlaywrightException("Don´t possible validate Started appointment");
                }
        ...
        public async Task InProgress()
        {
                ...
                {
                    throw new PlaywrightException("Don´t possible validate appointment in progress");
                }
        ...
        public async Task Canceled()
        {
            ...
            {
                throw new PlaywrightException("Don´t possible validate canceled appointment");
            }
        }
